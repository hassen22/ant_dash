 ...
 const handleClick = onItemClick
  ...
  const langMenu = (
    ...
    >
        ...
        <Menu.Item key={'fr-FR'} style={menuItemStyle}>
          <span role='img' aria-label={allLangUIConfig['fr-FR']?.label  || 'fr-FR'}>
            {allLangUIConfig['fr-FR']?.icon || "🌐"}
          </span>{' '}
          {allLangUIConfig['fr-FR']?.label || 'fr-FR'}
        </Menu.Item>
